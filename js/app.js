...
function initSliders() {
  ...
  if (document.querySelector('.slider-steps')) { //Указываем класс нужного слайдера
    //Создаем слайдер
    new Swiper('.slider-steps__slider', { //Указываем класс нужного слайдера
